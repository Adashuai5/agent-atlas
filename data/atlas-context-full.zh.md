...
本机检测到 3 个运行时 consumer
当前资源面可见 151 项；enabled\-confirmed 0，loaded\-confirmed 0。另有 382 项库存，资源面积不代表实际使用。
...
- skill | consumer=none | storage=project | auto\-start | present=true valid=true enabled=unknown loaded=unknown | inactive | /Users/ada/Desktop/下一程/\.claude/skills/auto\-start
...
- memory | consumer=none | storage=project | CLAUDE\.md | present=true valid=true enabled=unknown loaded=unknown | inactive | /Users/ada/Desktop/下一程/CLAUDE\.md
...
- config | consumer=claude | storage=claude | settings\.local\.json | present=true valid=true enabled=unknown loaded=unknown | healthy | /Users/ada/\.claude/settings\.local\.json
- config | consumer=none | storage=project | settings\.local\.json | present=true valid=true enabled=unknown loaded=unknown | inactive | /Users/ada/Desktop/下一程/\.claude/settings\.local\.json
...
- skill | consumer=none | storage=project | stock\-research | present=true valid=true enabled=unknown loaded=unknown | inactive | /Users/ada/Desktop/下一程/\.claude/skills/stock\-research
